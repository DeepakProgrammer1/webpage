...
<body>
    ...
    <!-- CARDS -->
    <div class="container marketing shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <div class="container text-center">
        <button class="btn btn-primary btn-center" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">Click to Know more</button>

        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title " id="offcanvasWithBothOptionsLabel "> <u>
                        DEEPAK SINGH KUSHWAHA</u></h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body">
                <p> <h1><b> <i>Welcome to iCoder</i> </b></h1><br>
